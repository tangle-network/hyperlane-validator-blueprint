...
COPY --from=app-builder /app/target/release/hyperlane-validator-blueprint-bin /usr/local/bin
...
ENTRYPOINT ["/usr/local/bin/hyperlane-validator-blueprint-bin", "run"]
